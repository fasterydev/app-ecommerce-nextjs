...
// Admin/Usuario: Obtener todas las marcas (soporta filtros/paginación)
export const getBrands = async (params?: {
  ...
  try {
    ...
    const url = `${envs.BackendUrl}/products/getBrands${
    ...
    return {
      ...
      brands: Array.isArray(resData)
        ? resData
        : resData.brands || resData.data || [],
